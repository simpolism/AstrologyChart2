...
test('AspectUtils.getAspects', () => {
  ...
  // check out-of-sign aspect handling
  ...
  aspects = AspectUtils.getAspects(FROM_POINTS, TO_POINTS, ASPECT, true)
  ...
  aspects = AspectUtils.getAspects(FROM_POINTS, TO_POINTS, ASPECT, false)
